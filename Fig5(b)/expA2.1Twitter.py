...
# title = "expA2.1Tom_" + str(rank) + "_acc.mat"
# sio.savemat(title, {'Init': acc_ini, 'DeKPCA': acc_DeKPCA, 'JMLR': acc_JMLR})

if rank == 0:
    with open("expA2.1Twitter_result_time.csv", "w", newline='') as f:
        f_csv = csv.writer(f)
    ...
    with open("expA2.1Twitter_result_acc.csv", "w", newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerow(["Init:"])
