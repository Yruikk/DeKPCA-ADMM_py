...
for rep_iter in range(pms.max_repeat):
    ...
    if rank == 0:
        ...
        split_X_tr = np.array_split(X_train, [230, 460, 690, 920, 970, 1200, 1430, 1660, 1890], axis=0)
        split_Y_tr = np.array_split(Y_train, [230, 460, 690, 920, 970, 1200, 1430, 1660, 1890], axis=0)
    else:
        split_X_tr = None
        split_Y_tr = None
        # X_test = None
...
if rank == 0:
    with open("expA1.2Twitter_result_time.csv", "w", newline='') as f:
        f_csv = csv.writer(f)
    ...
    with open("expA1.2Twitter_result_acc.csv", "w", newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerow(["Init:"])
